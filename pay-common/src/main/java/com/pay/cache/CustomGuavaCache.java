 ...
 */
public class CustomGuavaCache implements Cache {
    ...
    public CustomGuavaCache(String name) {
    ...
    public CustomGuavaCache(String name, com.google.common.cache.Cache cache) {
        this(name, cache, true);
    }

    public CustomGuavaCache(String name, com.google.common.cache.Cache cache, boolean allowNullValues) {
        this.cache = cache;
        this.name = name;
